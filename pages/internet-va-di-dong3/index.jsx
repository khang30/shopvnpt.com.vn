    ...
    <Layout>
      <div className="container mx-auto pt-4 sm:text-sm md:text-lg ">
        ...
        <div className="rounded-xl text-right p-0 md:p-0 lg:p-0">
            ...
            <li>&emsp; VNPT cung cấp các gói cước combo ưu đãi: Gói VNPT Home Tiết Kiệm giúp khách hàng tiết kiệm chi phí với internet, truyền hình và điện thoại. Gói VNPT Home Đỉnh mang đến tốc độ internet cao và truyền hình chất lượng. Gói VNPT Home Kết Nối tạo kết nối linh hoạt với internet, truyền hình và điện thoại. Gói VNPT Home Thể Thao tập trung vào nội dung thể thao phong phú. Dưới đây là bảng giá mới nhất:</li>
              </ul>
          </h2>
          </div>
