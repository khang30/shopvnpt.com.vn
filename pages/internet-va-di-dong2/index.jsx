    ...
    <Layout>
      <div className="container mx-auto pt-4 sm:text-sm md:text-lg ">
        ...
        <div className="rounded-xl text-right p-0 md:p-0 lg:p-0">
            ...
            <li>&emsp; VNPT Home Chất là dịch vụ gói cước cao cấp của VNPT, bao gồm internet tốc độ cao, truyền hình và điện thoại. Với hơn 180 kênh truyền hình chất lượng, nhiều tính năng tiện ích và dịch vụ điện thoại đáng tin cậy, gói VNPT Home Chất mang đến trải nghiệm giải trí và liên lạc toàn diện cho gia đình. Dưới đây là bảng giá mới nhất:</li>
              </ul>
          </h2>
          </div>
